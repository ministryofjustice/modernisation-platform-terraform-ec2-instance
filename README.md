...
| <a name="input_backup"></a> [backup](#input\_backup) | Optionally specify whether this EC2 should be backe up. Set to all for both ec2 and ebs backups, ec2 for ec2 only backup or ebs for ebs only backup. | `string` | `"all"` | no |
